...
grp_proc_info.src_dir={'Edit path based on project'}; %the directory containing your source files
grp_proc_info.beapp_curr_run_tag = 'tb_beapp'; % The tag you would like to append to folder names for this run. def = '' or 'NONE'. 'NONE' mutes timestamping. If not given on a rerun, a timestamp will be used. 
