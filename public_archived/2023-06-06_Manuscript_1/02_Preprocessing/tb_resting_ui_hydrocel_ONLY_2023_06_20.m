...
grp_proc_info.src_dir={'L:\Groups\ABCCT\EEG\T1 T2 T3 EEG\T1a_Resting'}; %the directory containing your source files
...
grp_proc_info.beapp_prev_run_tag = 'HAPPE'; % def = ''.  run tag for previous run that you would like to use as source data for rerun. can be timestamp, but must be exact.
